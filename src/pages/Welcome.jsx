...
export default function WelcomePage() {
  ...
  const manOffset = useTransform(scrollY, [0, 500], [50, 300]);
  const textOffset = useTransform(scrollY, [0, 500], ['30%', '80%']);

  return (
    <>
      <header id="welcome-header">
        <motion.div id="welcome-header-content" style={{top: textOffset}}>
        ...
        <motion.img
          ...
          id="city-image"
        />
        <motion.img src={heroImg} style={{bottom: manOffset}} alt="A superhero wearing a cape" id="hero-image" />
      </header>
